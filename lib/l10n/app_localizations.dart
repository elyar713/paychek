...
abstract class AppLocalizations {
  ...
  /// No description provided for @helpCenterArticleDashboardTitle.
  ///
  /// In fr, this message translates to:
  ...
  /// In fr, this message translates to:
  /// **'FONDAMENTAL'**
  String get analyseReportOledSectionFundamental;

  /// No description provided for @analyseReportOledSectionVolumeProfile.
  ///
  /// In fr, this message translates to:
  /// **'VOLUME PROFILE'**
  String get analyseReportOledSectionVolumeProfile;

  /// No description provided for @analyseReportOledSectionKeyZone.
  ///
  /// In fr, this message translates to:
  /// **'ZONE CLÉ'**
  String get analyseReportOledSectionKeyZone;

  /// No description provided for @analyseReportOledSectionSmc.
  ///
  /// In fr, this message translates to:
  /// **'SMC'**
  String get analyseReportOledSectionSmc;

  /// No description provided for @analyseReportOledSectionEntry.
  ///
  /// In fr, this message translates to:
  /// **'ENTRÉE'**
  String get analyseReportOledSectionEntry;

  /// No description provided for @analyseReportOledSectionHidden.
  ///
  /// In fr, this message translates to:
  /// **'Section masquée'**
  String get analyseReportOledSectionHidden;

  /// No description provided for @analyseReportOledFieldChartism.
  ///
  /// In fr, this message translates to:
  /// **'CHARTISME'**
  String get analyseReportOledFieldChartism;

  /// No description provided for @analyseReportOledFieldMacroNotes.
  ///
  /// In fr, this message translates to:
  /// **'NOTES MACRO'**
  String get analyseReportOledFieldMacroNotes;

  /// No description provided for @analyseReportOledFieldSignals.
  ///
  /// In fr, this message translates to:
  /// **'SIGNAUX'**
  String get analyseReportOledFieldSignals;

  /// No description provided for @analyseReportOledFieldActionPlan.
  ///
  /// In fr, this message translates to:
  /// **'PLAN D\'ACTION'**
  String get analyseReportOledFieldActionPlan;

  /// No description provided for @analyseReportOledLiquidity.
  ///
  /// In fr, this message translates to:
  /// **'Liquidité'**
  String get analyseReportOledLiquidity;

  /// No description provided for @analyseReportShowOnDashboard.
  ///
  /// In fr, this message translates to:
  /// **'Afficher sur l\'accueil'**
  String get analyseReportShowOnDashboard;

  /// No description provided for @analyseReportRemoveFromDashboard.
  ///
  /// In fr, this message translates to:
  /// **'Retirer de l\'accueil'**
  String get analyseReportRemoveFromDashboard;

  /// No description provided for @analyseReportEditTooltip.
  ///
  /// In fr, this message translates to:
  /// **'Modifier — recharger la feuille depuis ce rapport'**
  String get analyseReportEditTooltip;

  /// No description provided for @analyseReportExportPdfTooltip.
  ///
  /// In fr, this message translates to:
  /// **'Exporter en PDF'**
  String get analyseReportExportPdfTooltip;

  /// No description provided for @analyseReportDeleteTooltip.
  ///
  /// In fr, this message translates to:
  /// **'Supprimer le rapport'**
  String get analyseReportDeleteTooltip;
