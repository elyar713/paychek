...
abstract final class CoachAiResponseFormat {
  /// EN pour de/es/pt/ko + consigne « réponds dans la langue cible ».
  static String _focusInstr(
    String languageCode, {
    required String en,
    required String fr,
  }) {
    ...
    if (lc == 'fr') return fr;
    if (lc == 'en') return en;
    return '${CoachAiLocale.mustRespondIn(lc)}\n$en';
  }
  ...
  static String narrativeInstructions(String languageCode) => _focusInstr(
        languageCode,
        en:
            'MANDATORY OUTPUT (plain text, no markdown): '
        ...
        fr:
            'FORMAT DE SORTIE OBLIGATOIRE (texte brut, pas de markdown) : '
  ...
  static String storyFollowUpInstructions(String languageCode) => _focusInstr(
        languageCode,
        en:
            'MANDATORY: Read conversation.priorTurns (Revenge, FOMO, etc.). '
        ...
        fr:
            'FORMAT OBLIGATOIRE : lis conversation.priorTurns (revenge, FOMO, etc.). '
  ...
  static String pricingInstructions(String languageCode) => _focusInstr(
        languageCode,
        en:
            'FOCUS=PAYCHEK app pricing (NOT trade prices). Use pricingContext JSON only — never say "check the website" without numbers. '
        ...
        fr:
            'FOCUS=tarifs app PAYCHEK (PAS prix de trade). Utilise uniquement pricingContext — interdit « consulte le site » sans chiffres. '
  ...
  static String performanceSummaryInstructions(String languageCode) => _focusInstr(
        languageCode,
        en:
            'FOCUS=PAYCHEK Performance page summary (recorded vs incomplete discipline split). '
        ...
        fr:
            'FOCUS=résumé page Performance PAYCHEK (discipline complète vs incomplète). '
  ...
  static String performanceSummaryFollowUpInstructions(String languageCode) =>
      _focusInstr(
        languageCode,
        en:
            'FOCUS=brief follow-up after performance_summary. Read priorTurns — max 90 words. No full audit.',
        fr:
            'FOCUS=suite brève après performance_summary. Lis priorTurns — max 90 mots. Pas d’audit complet.',
      );

  static String performanceLensInstructions(String languageCode) => _focusInstr(
        languageCode,
        en:
            'FOCUS=Paychek Lens (Performance page). Use performanceLensContext only. '
        ...
        fr:
            'FOCUS=Paychek Lens (page Performance). Utilise performanceLensContext uniquement. '
  ...
  static String performanceLensFollowUpInstructions(String languageCode) =>
      _focusInstr(
        languageCode,
        en: 'FOCUS=brief follow-up after performance_lens. priorTurns only. Max 90 words.',
        fr:
            'FOCUS=suite brève après performance_lens. priorTurns uniquement. Max 90 mots.',
      );
  ...
  static String performanceOvertradingInstructions(String languageCode) =>
      _focusInstr(
        languageCode,
        en:
            'FOCUS=day volume / overtrading (Performance → Day & volume). Use performanceOvertradingContext buckets. '
        ...
        fr:
            'FOCUS=volume journalier / overtrading (Performance → Journée & volume). Utilise buckets du JSON. '
  ...
  static String performanceOvertradingFollowUpInstructions(String languageCode) =>
      _focusInstr(
        languageCode,
        en:
            'FOCUS=brief follow-up after performance_overtrading. priorTurns only. Max 90 words.',
        fr:
            'FOCUS=suite brève après performance_overtrading. priorTurns uniquement. Max 90 mots.',
      );

  static String calendarTodayInstructions(String languageCode) => _focusInstr(
        languageCode,
        en:
            'FOCUS=today\'s PAYCHEK Calendar synthesis (trades + discipline + month context), NOT global discipline audit. '
        ...
        fr:
            'FOCUS=synthèse calendrier DU JOUR (trades + discipline + mois), PAS audit discipline global. '
  ...
  static String calendarTodayFollowUpInstructions(String languageCode) =>
      _focusInstr(
        languageCode,
        en:
            'FOCUS=brief follow-up after calendar_today. Read priorTurns — answer ONLY the new question. Max 90 words. No audit.',
        fr:
            'FOCUS=suite brève après calendar_today. Lis priorTurns — réponds UNIQUEMENT à la nouvelle question. Max 90 mots. Pas d’audit.',
      );

  static String calendarMonthInstructions(String languageCode) => _focusInstr(
        languageCode,
        en:
            'FOCUS=current month on PAYCHEK Calendar (objective + PnL + winrate + green/red days), NOT global audit. '
        ...
        fr:
            'FOCUS=mois en cours sur Calendrier PAYCHEK (objectif + PnL + winrate + jours verts/rouges), PAS audit global. '
  ...
  static String calendarMonthFollowUpInstructions(String languageCode) =>
      _focusInstr(
        languageCode,
        en:
            'FOCUS=brief follow-up after calendar_month. Read priorTurns — answer ONLY the new question. Max 90 words.',
        fr:
            'FOCUS=suite brève après calendar_month. Lis priorTurns — réponds UNIQUEMENT à la nouvelle question. Max 90 mots.',
      );

  static String strategyTodayInstructions(String languageCode) => _focusInstr(
        languageCode,
        en:
            'FOCUS=today\'s PAYCHEK Strategy page (setup + risk + rules), NOT trade discipline audit. '
        ...
        fr:
            'FOCUS=stratégie DU JOUR (page Stratégie PAYCHEK), PAS audit discipline des trades. '
  ...
  static String strategyTodayFollowUpInstructions(String languageCode) =>
      _focusInstr(
        languageCode,
        en:
            'FOCUS=brief follow-up on the PREVIOUS strategy_today answer. '
        ...
        fr:
            'FOCUS=suite brève après strategy_today. '
  ...
  static String analysisTodayInstructions(String languageCode) => _focusInstr(
        languageCode,
        en:
            'FOCUS=today\'s PAYCHEK Analysis page (Mon Analyse), NOT trade discipline audit. '
        ...
        fr:
            'FOCUS=analyse DU JOUR (page Analyse PAYCHEK), PAS audit discipline des trades. '
  ...
  static String analysisTodayFollowUpInstructions(String languageCode) =>
      _focusInstr(
        languageCode,
        en:
            'FOCUS=brief follow-up on the PREVIOUS analysis_today answer. '
            'Read conversation.priorTurns — answer ONLY the new question (e.g. most important point). '
            'Max 2-3 sentences OR 1 intro + 2 numbered lines. No discipline audit, no trade stats.',
        fr:
            'FOCUS=suite brève après analysis_today. '
            'Lis conversation.priorTurns — réponds UNIQUEMENT à la nouvelle question (ex. point le plus important). '
            'Max 2-3 phrases OU 1 intro + 2 lignes numérotées. Pas d’audit discipline, pas de stats trades.',
      );

  static String checklistTodayInstructions(String languageCode) => _focusInstr(
        languageCode,
        en:
            'FOCUS=today\'s PAYCHEK Checklist page (tasks due today), NOT trade discipline audit. '
        ...
        fr:
            'FOCUS=checklist DU JOUR (page Checklist PAYCHEK), PAS audit discipline des trades. '
  ...
  static String checklistTodayFollowUpInstructions(String languageCode) =>
      _focusInstr(
        languageCode,
        en:
            'FOCUS=brief follow-up on the PREVIOUS checklist_today answer. '
            'Read conversation.priorTurns — answer ONLY the new question (e.g. most important point). '
            'Max 2-3 sentences OR 1 intro + 2 numbered lines. No discipline audit, no trade stats, no generic checklist template.',
        fr:
            'FOCUS=suite brève après checklist_today. '
            'Lis conversation.priorTurns — réponds UNIQUEMENT à la nouvelle question (ex. point le plus important). '
            'Max 2-3 phrases OU 1 intro + 2 lignes numérotées. Pas d’audit discipline, pas de stats trades, pas de checklist générique.',
      );

  static String mentalTodayInstructions(String languageCode) => _focusInstr(
        languageCode,
        en:
            'FOCUS=today\'s mental state (Mental state page), NOT discipline audit / recorded trades. '
        ...
        fr:
            'FOCUS=état mental DU JOUR (page État mental), PAS audit discipline / trades enregistrés. '
  ...
  static String pillarImprovementInstructions(String languageCode) => _focusInstr(
        languageCode,
        en:
            'FOCUS=action plan to improve ONE discipline pillar toward a target (e.g. 60% strategy compliance). '
        ...
        fr:
            'FOCUS=plan d’action pour améliorer UN pilier discipline vers un objectif (ex. 60 % sur la stratégie). '
